...
public class App {
    public static void main(String[] args) throws IOException {
        File file = new File("1-11-Java-IV-82-Ivashchenko.txt");
        ...
        FileHandler fh = new FileHandler("1-11-Java-IV-82-Ivashchenko.log");
        ...
        File sourceFile = new File("1-11-Java-IV-82-Ivashchenko.asm");
